...
set LLAMA_EXE=%BASE_DIR%bin\llama-server.exe
...
:: 3. Tentar encontrar um modelo .gguf na pasta data\models
...
start "llama-server" /min "%LLAMA_EXE%" -m "!GGUF_MODEL!" --port 8080 -c 32768 --no-warmup
